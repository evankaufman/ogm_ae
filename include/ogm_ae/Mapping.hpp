...
public:
  ...
  // __ Functions __ \\
    ...
    bool GenerateRvizMarkerArrayMsg(ogm_ae::UpdatedMapCells& possiblyChangedCells,
                                    visualization_msgs::Marker& marker, visualization_msgs::MarkerArray& markerArrayMsg, visualization_msgs::MarkerArray& markerBuff, double& occupancyVizMin, double& probRange,
                                    std_msgs::Float64MultiArray& rdcdMapOccDataBuff, vector<bool>& rdcdMapColorDataBuff);
